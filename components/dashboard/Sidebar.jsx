        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center gap-3">
            <Link href="/dashboard" className="flex items-center gap-2">
              <Image src={Logo} alt="Logo" className="w-12 h-12 rounded-full object-cover" />
              <h2 className="text-xl font-bold text-white italic tracking-wide">
            ...
            <div>
              ...
              {openMenus.services && (
                <div className="pl-6 mt-1 space-y-1">
                  {[
                    {
                      href: "/dashboard/services/waec",
                      label: "WAEC Scratch Card",
                      icon: FaFileAlt,
                    },
                    {
                      href: "/dashboard/services/neco",
              ...
              {openMenus.history && (
                <div className="pl-6 mt-1 space-y-1">
                  {[
                    ...
                    {
                      href: "/dashboard/history/waec",
                      label: "WAEC History",
                      icon: FaFileAlt,
                    },
                    {
                      href: "/dashboard/history/neco",
                      label: "NECO History",
                      icon: FaIdCard,
                    },
